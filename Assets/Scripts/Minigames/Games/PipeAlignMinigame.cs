...
namespace SpaceMaintenance.Minigames.Games
{
    public class PipeAlignMinigame : MinigameBase
    {
        ...
        protected override void OnStart()
        {
            ...
            // Level 1: 3x3, base time
            // Level 2: 3x3, less time
            // Level 3: 4x4, same time as L2
            // Level 4: 4x4, less time
            // Odd levels increase grid, Even levels decrease time.
            int gridTier = (Difficulty - 1) / 2; // 0, 0, 1, 1, 2, 2...
            _width = Mathf.Clamp(3 + gridTier, 3, 6);
            _height = Mathf.Clamp(3 + gridTier, 3, 5); // caps at 5 height so 6x5 max

            int timeTier = Difficulty / 2; // 0, 1, 1, 2, 2, 3...
            _maxTime = Mathf.Max(10f, 35f - (timeTier * 5f));
